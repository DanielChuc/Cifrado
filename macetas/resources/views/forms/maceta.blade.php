    ...
    <div class="grid grid-cols-1  items-center">
        <div class=" rounded-tl-lg bg-white md:w-auto">
            ...
            <div class="grid grid-cols-1 space-y-2">
                ...
                <input type="text" placeholder="Nombre" class="ml-6 mr-6 text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500 shadow-lg" 
            ...
            <div class="grid grid-cols-1 space-y-2">
                ...
                <input type="text" placeholder="Descripción" class="ml-6 mr-6 text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500 shadow-lg" 
            ...
            <div class="grid grid-cols-1 space-y-2">
                ...
                <input type="text" placeholder="Color" class="ml-6 mr-6 text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500 shadow-lg" 
            ...
            <input type="number" min="1" max="100" placeholder="Cantidad" class="ml-6 mr-6 text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500 shadow-lg" 
            ...
            <div class="grid grid-cols-1 space-y-2">
                ...
                <input type="text" placeholder="Material" class="ml-6 mr-6 text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500 shadow-lg" 
            ...
            <div class="grid grid-cols-1 space-y-2">
              {{--    <label class="text-sm font-bold text-gray-500 tracking-wide" for="#">FIle: </label>
                <input type="text" placeholder="File" class="ml-6 mr-6 text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500 shadow-lg" 
                ...
                <div class="flex items-center justify-center w-full">
                    <label class="flex flex-col rounded-lg border-4 border-dashed w-full h-60 p-10 group text-center">
                        <div class="h-full w-full text-center flex flex-col items-center justify-center items-center  ">
                            ...
                            <img src="https://cdn-icons.flaticon.com/png/512/3097/premium/3097412.png?token=exp=1635907417~hmac=f7cfc866a2f0ee2e830a0cbe4e3b1ed1" alt="upload" title="Upload " class="loaded" width="256" height="256">
                            </div>
                        </div>
